...
| 방법 | 명령 | 적합한 경우 |
|------|------|-------------|
| wheel 직접 전달 | `pip install ./docstruct-0.1.11-py3-none-any.whl` | 소수 인원, 폐쇄망 |
| git 저장소 | `pip install git+ssh://git@183.96.152.133/mjseo/docstruct.git@v0.1.11` | 사내 git 이 있을 때 |
