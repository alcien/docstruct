...
# 비공개 저장소 (토큰 필요)
pip install "docstruct @ git+https://<token>@github.com/alcien/docstruct.git@v0.1.29"

# SSH 키가 등록되어 있으면
pip install "docstruct @ git+ssh://git@github.com/alcien/docstruct.git@v0.1.29"
```
...
```bash
pip install https://github.com/alcien/docstruct/releases/download/v0.1.9/docstruct-0.1.29-py3-none-any.whl
```
