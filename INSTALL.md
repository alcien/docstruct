...
```bash
pip install "docstruct[notebook] @ git+http://183.96.152.133/mjseo/docstruct.git@v0.1.14"
```
...
```
docstruct[hwp,pdf] @ git+http://183.96.152.133/mjseo/docstruct.git@v0.1.14
```

### 업데이트

```bash
pip install -U "docstruct @ git+http://183.96.152.133/mjseo/docstruct.git@v0.1.14"

# 같은 태그를 다시 밀었다면 캐시를 비웁니다
pip install --force-reinstall --no-cache-dir \
  "docstruct @ git+http://183.96.152.133/mjseo/docstruct.git@v0.1.14"
```
...
```bash
# 배포 측
python -m build --wheel          # dist/docstruct-0.1.14-py3-none-any.whl

# 설치 측
pip install docstruct-0.1.14-py3-none-any.whl
...
태그를 붙여 설치하면 이 문제를 겪지 않습니다 (`@v0.1.14`).
